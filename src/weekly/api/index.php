...
function getAllWeeks($db) {
    ...
    $stmt = $db->prepare("SELECT week_id, title, start_date, description, links, created_at FROM weeks" . (!empty($search) ? " WHERE title LIKE ? OR description LIKE ?" : "") . " ORDER BY $sort $order");
...
// ============================================================================
// MAIN REQUEST ROUTER WITH TRY-CATCH
// ============================================================================
